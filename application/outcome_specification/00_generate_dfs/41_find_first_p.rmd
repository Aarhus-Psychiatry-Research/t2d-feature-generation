...
df_lpr3_preproc <- con %>% 
  tbl(sql("SELECT * FROM [fct].FOR_LPR3kontakter_psyk_somatik_inkl_2021_feb2022")) %>% 
...
df_lpr2_inp_preproc <- con %>% 
  tbl(sql("SELECT * FROM [fct].FOR_indlaeggelser_psyk_somatik_LPR2_inkl_2021_feb2022")) %>% 
...
df_lpr2_outp_preproc <- con %>% 
  tbl(sql("SELECT * FROM [fct].FOR_besoeg_psyk_somatik_LPR2_inkl_2021_feb2022")) %>% 
